        ...
        <div className="space-y-12">
          <section className="space-y-4">
            ...
            <p className="text-gray-600">
              At SmartCityTourGuide, we believe that exploring India should be an enriching, hassle-free experience for every traveler. Our mission is to simplify travel planning while ensuring that visitors get to experience the authentic beauty, culture, and heritage of India.
            </p>
            <p className="text-gray-600">
          ...
          <section className="space-y-4">
            ...
            <p className="text-gray-600">
            SmartCityTourGuide was born from the personal travel experiences of our founders, who recognized the challenges international and domestic tourists face when planning trips across India. 
            </p>
            <p className="text-gray-600">
            ...
            <p className="text-gray-600">
              Launched in 2025, our platform combines local expertise with innovative technology to create personalized travel experiences that showcase the best of what India has to offer.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-gray-600">
              We're constantly working to enhance the SmartCityTourGuide experience. Our roadmap includes expanding our coverage to more remote destinations, integrating real-time weather and crowd data, and developing mobile applications for on-the-go planning.
            </p>
            <p className="text-gray-600">
      ...
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl text-center">
          ...
          <p className="text-gray-600 mb-8">
            Whether you're planning your first trip to India or you're a seasoned traveler looking to explore new regions, SmartCityTourGuide is here to help you create unforgettable experiences.
          </p>
