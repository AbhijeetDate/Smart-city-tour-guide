      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/explore?city=delhi" className="text-gray-400 hover:text-white transition-colors">Delhi</Link></li>
              <li><Link to="/explore?city=jaipur" className="text-gray-400 hover:text-white transition-colors">Jaipur</Link></li>
              <li><Link to="/explore?city=agra" className="text-gray-400 hover:text-white transition-colors">Agra</Link></li>
              <li><Link to="/explore?city=goa" className="text-gray-400 hover:text-white transition-colors">Goa</Link></li>
              <li><Link to="/explore?city=varanasi" className="text-gray-400 hover:text-white transition-colors">Varanasi</Link></li>
            </ul>
          </div>
